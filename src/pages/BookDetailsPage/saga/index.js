...
export default function* watchBookDetailsPage() {
  yield all([
    ...
    takeEvery(UserReviewActions.SUBMIT_USER_REVIEW_SUCCESS, ACTIONS.ADD_NEW_BOOK_REVIEW),
    takeEvery(UserReviewActions.UPDATE_USER_REVIEW_SUCCESS, ACTIONS.UPDATE_BOOK_REVIEW),
  ]);
}
